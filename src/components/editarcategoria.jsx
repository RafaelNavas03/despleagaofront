...
const EditarCategoria = ({ onCancel }) => {
  ...
  const fetchCategorias = async () => {
    try {
      const responseCategorias = await fetch('https://desplegaobak-production.up.railway.app/producto/listar_categorias/');
      const dataCategorias = await responseCategorias.json();

      const responseTiposProductos = await fetch('https://desplegaobak-production.up.railway.app/producto/listarproductos/');
  ...
  const eliminartp = async (idca) => {
    try {
      ...
      const response = await fetch(`https://desplegaobak-production.up.railway.app/producto/editar_categoria/${idca}/`, {
        method: 'POST',
        body: formData,
      });
  ...
  const listarca = () => {
    const fetchTiposProductos = async () => {
      ...
      try {
        const response = await fetch('https://desplegaobak-production.up.railway.app/producto/listarproductos/');
  ...
  const handleUpdateCategoria = async (values) => {
    try {
      ...
      const response = await fetch(
        `https://desplegaobak-production.up.railway.app/producto/editar_categoria/${selectedCategoria.id_categoria}/`,
        {
          method: 'POST',
          body: formData,
        }
