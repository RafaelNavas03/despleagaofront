...
const ConfigUM = () => {
  ...
  useEffect(() => {
    ...
    const obtenerUnidadesMedida = async () => {
      try {
        const respuestaUnidadesMedida = await fetch('https://desplegaobak-production.up.railway.app/producto/listarum/');
  ...
  const obtenerConversiones = async () => {
    try {
      const respuestaConversiones = await fetch('https://desplegaobak-production.up.railway.app/producto/conversionesum/');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const respuestaConfiguracion = await fetch('https://desplegaobak-production.up.railway.app/producto/configurarensamble/', {
        method: 'POST',
        body: formData,
      });
