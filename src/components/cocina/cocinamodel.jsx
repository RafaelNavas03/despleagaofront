...
const CocinaFuncion = ({ componente, producto }) => {
    ...
    useEffect(() => {
        fetch('https://desplegaobak-production.up.railway.app/bodega/listar/')
    ...
    const verificarcomponentes = (canti) => {
        ...
        if (selectedItems.length > 0 && bodega && componente) {
            ...
            const promises = selectedItems.map(item => {
                ...
                return fetch('https://desplegaobak-production.up.railway.app/producto/componentenecesario/', {
                    method: 'POST',
                    body: formData,
                })
                    .then(response => response.json())
        ...
        if (selectedItems.length > 0 && bodega && producto) {
            ...
            const promises = selectedItems.map(item => {
                ...
                return fetch('https://desplegaobak-production.up.railway.app/producto/componentenecesariop/', {
                    method: 'POST',
                    body: formData,
                })
                    .then(response => response.json())
    ...
    const prepareComponent = () => {
        ...
        if (selectedItems.length > 0 && bodega && componente) {
            ...
            fetch('https://desplegaobak-production.up.railway.app/producto/fabricarcomponente/', {
                method: 'POST',
                body: formData,
            })
                .then(response => response.json())
        ...
        if (selectedItems.length > 0 && bodega && producto) {
            ...
            fetch('https://desplegaobak-production.up.railway.app/producto/fabricarproducto/', {
                method: 'POST',
                body: formData,
            })
                .then(response => response.json())
