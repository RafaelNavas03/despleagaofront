...
const CrearReservacionForm = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://desplegaobak-production.up.railway.app/Mesas/ver_mesas/')
      .then(response => response.json())
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await fetch('https://desplegaobak-production.up.railway.app/Mesas/crear_reservacion/', {
        method: 'POST',
        body: formData,
      });
  ...
  useEffect(() => {
    const loadHorarios = async () => {
      if (selectedDate) {
        ...
        try {
          const response = await fetch(`https://desplegaobak-production.up.railway.app/horarios/get/${dayId}`);
          if (!response.ok) {
