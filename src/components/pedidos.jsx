...
const RealizarPedido = ({ visible, onClose, bodega }) => {
  ...
  const listarp = async (id_tipoproducto) => {
    setLoading(true);
    try {
      let url = "https://desplegaobak-production.up.railway.app/producto/listar_categorias/";
  ...
  const handlePedidoSubmit = async (values) => {
    try {
      ...
      const response = await fetch(
        "https://desplegaobak-production.up.railway.app/Inventario/crearinventario/" +
          bodega.id_bodega +
          "/",
        {
          method: "POST",
