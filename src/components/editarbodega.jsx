...
const EditarBodegaForm = () => {
    ...
    const obtenerListas = async () => {
      try {
        ...
        const responseProveedores = await fetch(
          "https://desplegaobak-production.up.railway.app/Proveedores/listar_proveedor/"
        );
        ...
        const responseComponentes = await fetch(
          "https://desplegaobak-production.up.railway.app/producto/listarcomponentes/"
        );
        ...
        const responseUnidadesMedida = await fetch(
          "https://desplegaobak-production.up.railway.app/producto/listarum/"
        );
    ...
    const obtenerProductos = async () => {
      try {
        const responseProductos = await fetch(
          "https://desplegaobak-production.up.railway.app/producto/listar/"
        );
  ...
  const manejarEdicion = async () => {
    try {
      ...
      await fetch(`https://desplegaobak-production.up.railway.app/bodega/editar/${idBodega}/`, {
        method: "POST",
  ...
  const cargarBodegas = async () => {
    try {
      const response = await fetch(
        `https://desplegaobak-production.up.railway.app/bodega/listar/?page=${currentPage}`
      );
